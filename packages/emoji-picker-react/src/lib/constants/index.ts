...
export const GROUP_NAME_PEOPLE = 'smileys_people';
export const GROUP_NAME_NATURE = 'animals_nature';
export const GROUP_NAME_FOOD = 'food_drink';
export const GROUP_NAME_TRAVEL = 'travel_places';
...
export const GROUP_NAME_RECENTLY_USED = 'recently_used';
